  ...
  return (
    <>
      <div className="container-fluid">
        <div
          className="row my-3 mx-auto bg-white border"
          style={{ width: "1603px", height: "114px" }}
        >
          ...
          >
            ...
            <div class="carousel-inner">
              ...
              <div className="carousel-item">
                <img
                  src="https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/9f2d8a698cd97710.jpg?q=20"
                  alt="secondimage"
                />
              </div>
              <div className="carousel-item">
                <img
                  src="https://rukminim1.flixcart.com/fk-p-flap/1600/270/image/1575923f761f2f2a.jpg?q=20"
                  alt="thirdimage"
                />
              </div>
            </div>
